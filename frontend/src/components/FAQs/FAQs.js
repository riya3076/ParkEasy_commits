...
const FAQs = () => {
  ...
  const toggleExpand = (categoryIndex, questionIndex) => {
    setExpanded((prevExpanded) => {
      ...
      expandedState[categoryIndex] =
        expandedState[categoryIndex] === questionIndex ? null : questionIndex;
      ...
      questions: [
        {
          ...
          answer:
            "All parking rates are posted by the parking spot owner. We help guide owners in posting rates that are appropriate for the area and generally cheaper than the rates charged at public parking.",
        },
        {
          question: "How do I pay for renting a space?",
          answer:
            "Once you find your desired parking spot, you can select the book now option and it will direct you to the payment site and then you can enter your credit/debit card details for the payment.",
        },
        {
          question: "Can I extend my stay?",
          answer:
            "You may be able to extend your stay. Please contact the spot owner with your request.",
        },
        {
          question: "How can I provide feedback on your products or services?",
          answer:
            "We welcome your feedback! You can provide feedback by going to the support page on our website and by filling out the contact us form. We appreciate your input.",
        },
      ],
    },
    {
                ...
                <div key={questionIndex} className="faq-item">
                  <div
                    className={`faq-question ${
                      expanded[categoryIndex] === questionIndex
                        ? "expanded"
                        : ""
                    }`}
